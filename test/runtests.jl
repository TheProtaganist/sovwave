...
@testset "Sovwave v$(Sovwave.VERSION)" begin
    ...
    for f in (
        ...
        "audio/test_constants.jl", "audio/test_wavefunction.jl", "audio/test_wave_computing.jl", "audio/test_wave_math.jl", "audio/test_waveml.jl", "audio/test_waveml_modules.jl", "audio/test_utf8_multilingual.jl", "audio/test_wave_tokens.jl",
